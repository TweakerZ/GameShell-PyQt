...
class SettingsView(QWidget):
    ...
    def _build(self):
        ...
        theme_info = QLabel("Follows system theme")
        theme_info.setFont(QFont("Exo 2", 12))
        theme_info.setStyleSheet(f"color: {t.c(t.text_secondary)}; padding: 4px 0 8px;")
        content_layout.addWidget(theme_info)
